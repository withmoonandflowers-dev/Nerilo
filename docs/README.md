...
本目錄僅保留必要文件，其餘歷史／重複文件已移除。

| 文件 | 說明 |
|------|------|
| [架構文件.md](架構文件.md) | 系統架構、P2P/Mesh 元件 |
| [協議文件.md](協議文件.md) | P2P 協議定義 |
| [上板與部署手冊.md](上板與部署手冊.md) | 環境、上板指令、腳本、常見問題 |
| [新功能接入SOP.md](新功能接入SOP.md) | 新功能接入步驟 |
| [測試與驗收手冊.md](測試與驗收手冊.md) | 手動測試項目與驗收 |
| [完整測試流程.md](完整測試流程.md) | 測試執行順序、E2E 分組、流程對照 |
| [AI協作規範.md](AI協作規範.md) | 變更後必做、資安紅線、人工審核 |
| [系統改進與AI協作手冊.md](系統改進與AI協作手冊.md) | 待改進項目、CI/CD、問題修正流程 |
| [共享資料流設計.md](共享資料流設計.md) | 區塊鏈式共享資料流設計 |
| [投資者演示步驟.md](投資者演示步驟.md) | 投資者演示流程 |
