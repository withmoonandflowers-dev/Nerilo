...
- 關聯：ADR-0026（R1 處置：短期風險接受、排修 P1）、ADR-0023（P1 複本持久化，已落地）、風險登記 R1（docs/audit/core-invariants-risks.csv）、docs/QA-REPORT-chat.md 行 139-150、docs/mesh-correctness.md（殘留清單第 1 項）
