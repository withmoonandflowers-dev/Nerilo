...
- [ ] **Q2 full-mesh 與 partial-mesh 的切換邊界**：程式（≤6 full mesh）與 docs/DEVELOPMENT.md 文件（3-5 full mesh、6-20 partial）不一致，接線前必須拍板一個並修正另一個：
...
- [ ] V7 收尾文件：`docs/CURRENT-STATUS.md`、`docs/QA-REPORT-chat.md` 已知限制清單、`docs/CROSS-MACHINE-HANDOFF.md:161-165` Pro 權益段、docs/DEVELOPMENT.md 拓撲表、firestore.rules 註解、ADR-0003／0007 狀態同步更新。
